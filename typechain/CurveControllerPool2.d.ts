...
interface CurveControllerPool2Interface extends ethers.utils.Interface {
  functions: {
...
export class CurveControllerPool2 extends BaseContract {
  ...
  interface: CurveControllerPool2Interface;
