...
interface CurveControllerETHInterface extends ethers.utils.Interface {
  functions: {
    "ADD_LIQUIDITY_ROLE()": FunctionFragment;
    "ETH_REGISTRY_ADDRESS()": FunctionFragment;
    ...
    "deploy(address,uint256[2],uint256)": FunctionFragment;
    "manager()": FunctionFragment;
    "withdraw(address,uint256,uint256[2])": FunctionFragment;
    "withdrawImbalance(address,uint256[2],uint256)": FunctionFragment;
    "withdrawOneCoin(address,uint256,int128,uint256)": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "ETH_REGISTRY_ADDRESS",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class CurveControllerETH extends BaseContract {
  ...
  interface: CurveControllerETHInterface;

  functions: {
    ADD_LIQUIDITY_ROLE(overrides?: CallOverrides): Promise<[string]>;

    ETH_REGISTRY_ADDRESS(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    ETH_REGISTRY_ADDRESS(overrides?: CallOverrides): Promise<BigNumber>;
