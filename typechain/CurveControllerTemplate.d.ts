...
interface CurveControllerTemplateInterface extends ethers.utils.Interface {
  functions: {
...
export class CurveControllerTemplate extends BaseContract {
  ...
  interface: CurveControllerTemplateInterface;
