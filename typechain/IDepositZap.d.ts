...
interface IDepositZapInterface extends ethers.utils.Interface {
  functions: {
    "add_liquidity(address,uint256[4],uint256)": FunctionFragment;
    "remove_liquidity(address,uint256,uint256[3])": FunctionFragment;
    "remove_liquidity_imbalance(address,uint256[3],uint256)": FunctionFragment;
  };
...
export class IDepositZap extends BaseContract {
  ...
  interface: IDepositZapInterface;
  ...
  functions: {
    ...
    "remove_liquidity_imbalance(address,uint256[3],uint256)"(
      metaPoolAddress: string,
      amounts: [BigNumberish, BigNumberish, BigNumberish],
