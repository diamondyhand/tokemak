...
interface SushiswapControllerV1Interface extends ethers.utils.Interface {
  functions: {
...
export class SushiswapControllerV1 extends BaseContract {
  ...
  interface: SushiswapControllerV1Interface;
