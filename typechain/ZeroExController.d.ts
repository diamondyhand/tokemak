...
interface ZeroExControllerInterface extends ethers.utils.Interface {
  functions: {
...
export class ZeroExController extends BaseContract {
  ...
  interface: ZeroExControllerInterface;
