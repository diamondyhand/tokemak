...
interface CurveControllerV2TemplateInterface extends ethers.utils.Interface {
  functions: {
  ...
  events: {
    ...
    "RemoveLiquidity(address,uint256[2],uint256,uint256[2])": EventFragment;
...
export class CurveControllerV2Template extends BaseContract {
  ...
  interface: CurveControllerV2TemplateInterface;
  ...
  filters: {
    ...
    "RemoveLiquidity(address,uint256[2],uint256,uint256[2])"(
      provider?: string | null,
      token_amounts?: null,
      token_supply?: null,
      amounts?: null
