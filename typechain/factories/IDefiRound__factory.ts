...
import type { IDefiRound, IDefiRoundInterface } from "../IDefiRound";
...
export class IDefiRound__factory {
  static readonly abi = _abi;
  static createInterface(): IDefiRoundInterface {
    return new utils.Interface(_abi) as IDefiRoundInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IDefiRound {
    return new Contract(address, _abi, signerOrProvider) as IDefiRound;
  }
}
