...
interface CurveControllerV2Pool2Interface extends ethers.utils.Interface {
  functions: {
...
export class CurveControllerV2Pool2 extends BaseContract {
  ...
  interface: CurveControllerV2Pool2Interface;
