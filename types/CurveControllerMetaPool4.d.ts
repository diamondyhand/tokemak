...
interface CurveControllerMetaPool4Interface extends ethers.utils.Interface {
  functions: {
...
export class CurveControllerMetaPool4 extends BaseContract {
  ...
  interface: CurveControllerMetaPool4Interface;
