...
interface CurveControllerPool3Interface extends ethers.utils.Interface {
  functions: {
    ...
    "withdrawImbalance(address,uint256[3],uint256)": FunctionFragment;
...
export class CurveControllerPool3 extends BaseContract {
  ...
  interface: CurveControllerPool3Interface;
