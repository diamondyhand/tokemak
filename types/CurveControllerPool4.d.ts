...
interface CurveControllerPool4Interface extends ethers.utils.Interface {
  functions: {
...
export class CurveControllerPool4 extends BaseContract {
  ...
  interface: CurveControllerPool4Interface;
