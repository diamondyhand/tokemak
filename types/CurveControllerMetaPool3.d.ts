...
interface CurveControllerMetaPool3Interface extends ethers.utils.Interface {
  functions: {
...
export class CurveControllerMetaPool3 extends BaseContract {
  ...
  interface: CurveControllerMetaPool3Interface;
